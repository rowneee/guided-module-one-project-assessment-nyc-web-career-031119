...
rick_morty = TvShow.create(name: "Rick and Morty", weekday: "Tuesday", genre: "Comedy", summary: "Insert Bio Here")
...
handmaid = TvShow.create(name: "The Handmaid's Tale", weekday: "Tuesday", genre: "Drama", summary: "Insert Bio Here")
...
got = TvShow.create(name: "Game of Thrones", weekday: "Sunday", genre: "Action", summary: "One word: INCEST." )
westworld = TvShow.create(name: "Westworld", weekday: "Monday", genre: "Action", summary: "Westworld is a show about rich people gaining amusement through interaction with robots in a western-themed park. The rich people have the freedom to do anything they please. This show has violence, sex, and most importantly - a love story between robots…HOW ROMANTIC <3 <3")
svu = TvShow.create(name: "Law and Order: Special Victims Unit", weekday: "Tuesday", genre: "Action", summary: "The worst acting you will ever see!!! Every episode follows a different story investigated but the Special Victims Unit that will make you feel extremely sad. After watching one episode, you will know the entire intro by heart. *”…In New York City, the dedicated detectives who investigate these vicious felonies are members of an elite squad known as the Special Victims Unit. These are their stories…dooo dooo dooo dooo dooooo")
criminal_minds = TvShow.create(name: "Criminal Minds", weekday: "Wednesday", genre: "Action", summary: "Criminal investigation show, much like NCIS, but with hotter characters." )
sons = TvShow.create(name: "Sons of Anarchy", weekday: "Thursday", genre: "Action", summary: "There’s death everywhere, all the time. This show is about a group of bikers who break every single law in the book and get away with it.
")

glee = TvShow.create(name: "Glee", weekday: "Sunday", genre: "Romance", summary: "Insert Bio Here" )
vampire = TvShow.create(name: "The Vampire Diaries", weekday: "Monday", genre: "Romance", summary: "Do you like Twilight? Then pick another show, because these Vampires don’t sparkle and are not loyal to each other.")
once_upon = TvShow.create(name: "Once Upon a Time", weekday: "Tuesday", genre: "Romance", summary: "Ever try to imagine your girl Snow White living in the real world? Well this is the show for you. Snow and all her friends are hopping around a random town living their lives just how you imagined. Don’t worry though, Snow is not as innocent as you’d think.." )
himym = TvShow.create(name: "How I Met Your Mother", weekday: "Wednesday", genre: "Romance", summary: "If you feel bad about your dating life, watch this show to remind yourself that its impossible to find the one.")
true_blood = TvShow.create(name: "True Blood", weekday: "Thursday", genre: "Romance", summary: "Insert Bio H" )
