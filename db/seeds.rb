...
got = TvShow.create(name: "Game of Thrones", weekday: "Sunday", genre: "Drama")
simpsons = TvShow.create(name: "The Simpsons", weekday: "Sunday", genre: "Comedy")
twofour = TvShow.create(name: "24", weekday: "Monday", genre: "Action")
